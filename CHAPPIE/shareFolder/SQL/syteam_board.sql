...
ALTER TABLE BOARD_TABLE
ADD CONSTRAINT FK_BOARD_CATEGORY_ID FOREIGN KEY(CATEGORY_ID) REFERENCES CATEGORY_TABLE ON DELETE CASCADE;

ALTER TABLE BOARD_TABLE DROP CONSTRAINT FK_BOARD_CATEGORY_ID;
--���̺� �÷��� ����
ALTER TABLE BOARD_TABLE
