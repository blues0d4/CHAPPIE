...
DELETE FROM CATEGORY_TABLE WHERE CATEGORY_ID=2088;
---------------category member----------------
...
ALTER TABLE CATEGORY_MEMBER_TABLE DROP(USER_ID);

ALTER TABLE CATEGORY_MEMBER_TABLE
ADD CONSTRAINT FK_MEMBER_CATEGORY_ID FOREIGN KEY(CATEGORY_ID) REFERENCES CATEGORY_TABLE ON DELETE CASCADE;

INSERT INTO CATEGORY_MEMBER_TABLE(CATEGORY_ID, MEMBER_NICKNAME, USER_ID)
VALUES(2083, '쨩쨩이', '123');

SELECT * FROM CATEGORY_MEMBER_TABLE;
