...
ALTER TABLE TODO_LIST_TABLE DROP CONSTRAINT FK_TODO_CATEGORY_ID;

SELECT * FROM TODO_LIST_TABLE;

ALTER TABLE TODO_LIST_TABLE
ADD CONSTRAINT FK_TODO_CATEGORY_ID FOREIGN KEY(CATEGORY_ID) REFERENCES CATEGORY_TABLE ON DELETE CASCADE;

SELECT TODO_START_DATE, TODO_END_DATE FROM TODO_LIST_TABLE 
WHERE TO_DATE('17/07/21','YY/MM/DD') BETWEEN TODO_START_DATE AND TODO_END_DATE;
...
DELETE FROM TODO_MEMBER_TABLE WHERE TODO_NO=1107;
