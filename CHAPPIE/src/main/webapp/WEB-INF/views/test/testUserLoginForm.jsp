  ...
  <div class="login-box-body">
    ...
    <form action="../../index2.html" method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" value='' id="user_id" name="user_id" placeholder="이메일" required>
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" value='' id="user_pw" name="user_pw" placeholder="비밀번호" required>
    ...
    <a href="location.href='${URIs.URI_USER_JOIN_FORM}'" class="text-center">Register a new membership</a>
