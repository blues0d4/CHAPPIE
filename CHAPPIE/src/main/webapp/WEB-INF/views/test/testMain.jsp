...
<div class="popup-box chat-popup" id="qnimate">
    		  <div class="popup-head">
				<div class="popup-head-left pull-left"><img src="/resources/img/chappie_button.png" alt="iamgurdeeposahan"> CHAPPIE </div>
					  <div class="popup-head-right pull-right">
						...
						<button data-widget="remove" id="removeClass" class="chat-header-button pull-right" type="button"><i class="glyphicon glyphicon-remove-circle"></i></button>
                      </div>
			  </div>
